...
\medskip
\textit{joey.zenhausern@epfl.ch} % Your email address
}
...
\section{Methodology}
\subsection{Implementaton} % A subsection can be created just before a set of slides with a common theme to further break down your presentation into chunks
